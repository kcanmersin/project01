    ...
    public partial class AddSocialFeatures : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListFavorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListFavorites_MovieLists_MovieListId",
                        column: x => x.MovieListId,
                        principalTable: "MovieLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListFavorites_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListFavorites_MovieListId",
                table: "ListFavorites",
                column: "MovieListId");

            migrationBuilder.CreateIndex(
                name: "IX_ListFavorites_UserId_MovieListId",
                table: "ListFavorites",
                columns: new[] { "UserId", "MovieListId" },
                unique: true);
