...
public class UploadCoverImageCommandHandler : IRequestHandler<UploadCoverImageCommand, Result<ImageUploadResultDto>>
{
    private readonly IImageStorageService _imageStorage;
    private readonly DbContext _context;

    public UploadCoverImageCommandHandler(IImageStorageService imageStorage, DbContext context)
    {
        _imageStorage = imageStorage;
        _context = context;
    }

    public async Task<Result<ImageUploadResultDto>> Handle(UploadCoverImageCommand request, CancellationToken cancellationToken)
    {
